...
%     algorithm.
%
%     By default this function uses binomial filters (method='binomial').
%     If the method is specified as 'median', then a median filtering
%     method is used at the desired HPF cut-off frequency and the
